# Generated by Django 4.2.3 on 2023-12-29 16:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('barber_img', models.ImageField(storage=barberproject.storage_backends.PublicMediaStorage(), upload_to='barber_img')),
                ...
                ('barber_address', models.CharField(blank=True, max_length=300, null=True)),
